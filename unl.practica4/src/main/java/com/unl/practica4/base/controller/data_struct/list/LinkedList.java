package com.unl.practica4.base.controller.data_struct.list;

import com.unl.practica4.base.controller.data_struct.stack.Stack;
import com.unl.practica4.base.controller.data_struct.stack.StackImplementation;
...
public class LinkedList<E> {
    ...
    public E delete(Integer pos) throws Exception {
        if (isEmpty()) {
            ...
            E element = actualy.getData(); // Corregido: era preview.getData()
    ...
    public E delete(Integer pos, E element) throws Exception {
        return delete(pos);
    }
}